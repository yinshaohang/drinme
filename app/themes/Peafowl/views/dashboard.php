	...
	<div class="form-content">
			...
			case 'settings':
				...
				function read_the_docs($args=[]) {
					return _s('Learn more about %s at our %d.', [
						'%s' => $args['%s'],
						'%d' => '<a href="http://nullrefer.com/?https://chevereto.com/docs/'.$args['%k'].'" target="_blank">'._s('documentation').'</a>'
					]);
				}
		?>
		<form id="dashboard-settings" method="post" data-type="<?php echo get_dashboard(); ?>" data-action="validate" enctype="multipart/form-data">
			...
			<div class="input-label">
				...
				<div class="input-below"><?php _se('Check the <a %s>icon reference</a> for the complete list of supported icons.', 'href="http://nullrefer.com/?http://chevereto.com/src/icomoon" target="_blank"'); ?></div>
			</div>
			...
			<p><?php  _se('Routing allows you to customize default route binds on the fly. Only alphanumeric, hyphen and underscore characters are allowed. Check out our %s if you want to override or add new routes.', '<a href="http://nullrefer.com/?https://chevereto.com/docs/routes">' . _s('documentation') . '</a>'); ?></p>
			<div class="input-label">
