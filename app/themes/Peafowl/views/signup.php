	...
	<div class="content-width">
		...
		<div class="form-content overflow-auto">
			...
			<form id="form-signup" class="c9 phablet-c1 grid-columns" method="post" autocomplete="off" data-action="validate">
				...
				<div class="input-labe2">
					<label for="signup-code"><?php _se('Auth-code'); ?></label>
					<input type="code" name="code" id="signup-code" class="text-input" autocomplete="off" value="<?php echo get_safe_post()['code']; ?>" placeholder="<?php _se('付费用户专用填写，付费联系admin@drin.me开通高级权限功能/Authentication code, standard pay user test function, and pay user test function'); ?>" required>
					<span class="input-warning red-warning"><?php echo get_input_errors()["code"]; ?></span>
				</div>
