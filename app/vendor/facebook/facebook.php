...
abstract class BaseFacebook
{
   ...
   *
   * @param array $settings The application configuration
   */
  public function __construct($settings) {
    $this->setAppId($settings['appId']);
    $this->setAppSecret($settings['secret']);
    if (isset($settings['fileUpload'])) {
      $this->setFileUploadSupport($settings['fileUpload']);
    }
    if (isset($settings['trustForwarded']) && $settings['trustForwarded']) {
      $this->trustForwarded = true;
    }
    if (isset($settings['allowSignedRequest'])
        && !$settings['allowSignedRequest']) {
  ...
  protected function makeRequest($url, $params, $ch=null) {
	...
	if($json_result->error) {
		die('Facebook connect error: ['.$json_result->error->code.'] ' . $json_result->error->message);
	}
...
class Facebook extends BaseFacebook
{
   ...
   * we discover them.
   *
   * @param array $settings the application configuration. Additionally
  ...
  public function __construct($settings) {
    ...
    if (!empty($settings['sharedSession'])) {
