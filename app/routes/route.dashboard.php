			...
			case 'stats':
				...
				$system_values = [
					'chv_version'	=> [
						...
						'content'	=>  (version_compare($chv_version['files'], $chv_version['db'], '<=') ? $chv_version['files'] : $chv_version['files'] . ' ('.$chv_version['db'].' DB) <a href="'.G\get_base_url('install').'">'._s('install update').'</a>')
					],
					'support'		=> [
						'label'		=> 'Support',
						'content'	=> _s('Need help? Go to %s and you will get help quickly.', ['%s' => '<a href="http://nullrefer.com/?https://chevereto.com/support" target="_blank">'._s('Support').'</a>'])
					],
					'g_version'		=> [
						'label'		=> 'G\\',
				...
				$chevereto_urls = [
					_s('Support')				=> 'http://nullrefer.com/?https://chevereto.com/support',
					_s('Documentation')			=> 'http://nullrefer.com/?https://chevereto.com/docs',
					_s('Changelog')				=> 'http://nullrefer.com/?https://chevereto.com/changelog',
					_s('Request new features')	=> 'http://nullrefer.com/?https://chevereto.com/request-new-features',
					_s('Bug tracking')			=> 'http://nullrefer.com/?https://chevereto.com/bug-tracking',
					_s('Blog')					=> 'http://nullrefer.com/?https://chevereto.com/blog',
					_s('Community')				=> 'http://nullrefer.com/?https://chevereto.com/community',
					'GitHub' 					=> 'http://nullrefer.com/?https://github.com/Chevereto',
					'(NULLED BY FIRE2000)' 					=> 'https://www.escripts.club',
				];
				$chevereto_links = [];
